;(function($) {
    ...
    updatePosition: function() {
      ...
      */
      ...
      var diffOffset = {
        ...
        left: (elOffset.left - parentOffset.top+53)
      };
  ...
  function getPickerHTML() {
    ...
    if (localStorageSupport) {
      ...
      if(recentlyUsedEmojis.length>18){
        nodes.push('<section class="recent" data-count="' + 18 + '"' + displayRecentlyUsed + '>');
        recentlyUsedEmojis.length=18;
      }
      else{
